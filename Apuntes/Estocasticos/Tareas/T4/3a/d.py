...
VALOR_TEORICO = 0.178275

for s in range(10):
    intervalos_exceden_700 = 0
    total_intervalos = 1200
    ...
    for i in range(1200):
        ...
        # Check if this 5-minute interval exceeds 700g
        if peso_intervalo > 700:
            intervalos_exceden_700 += 1
    
    proporcion = intervalos_exceden_700 / total_intervalos
    lista_general.append([intervalos_exceden_700, total_intervalos, proporcion])
...
for i, sim in enumerate(lista_general):
    ...
    print(f"Simulación {i+1}: Intervalos que exceden 700g = {sim[0]}, Proporción = {sim[2]:.4f}, error absoluto = {error_absoluto:.4f}, error relativo = {error_relativo:.2f}%")
